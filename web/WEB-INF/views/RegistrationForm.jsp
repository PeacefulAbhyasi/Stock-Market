...
<body>
<center><h1>STOCK MARKET REGISTRATION</h1></center>
<c:if test="${ERROR == 'YES' }">
    <div class="container">
...
<div class="container" style="margin-top: 100px">
    <form role="form" action="/registration" method="post">
        ...
        <div class="input-group input-group-lg">
            ...
            <input type="text" style="margin-top: 2px" name="firstName" class="form-control" placeholder="FIRST NAME">
        </div>
        <br>
        <div class="input-group input-group-lg">
            <span class="input-group-addon glyphicon glyphicon-star-empty"></span>
            <input type="text" style="margin-top: 2px" name="lastName" class="form-control" placeholder="LAST NAME">
        </div>
        <br>
